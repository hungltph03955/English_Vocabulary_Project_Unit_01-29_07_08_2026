...
The project is active and ready for Codex-driven operation. The new operating
manual `AGENTS.md` has been added so future agents must read the required files
before generating quizzes.

The project now includes:

- Unit 01-26 source state from the 2026-07-31 handoff package
- Unit 27 `out-`
- Unit 28 `over-`
- Unit 29 `per-`
- Unit 30 `post-`
...
## Import instruction for Codex

After importing this ZIP, start every task by reading `AGENTS.md`. For quizzes,
