...
- Monday-Thursday: Daily Quick, 12 questions
- Every Friday: Weekly Quick, 30 questions
- Last Friday of month: Monthly Quick / Cumulative Test, 50 questions, replacing Weekly Quick
...
Unit 31 `pre-` vocabulary added on 2026-08-11:

- Book words: `prearranged`, `preorder`, `prepare`, `preschool`, `preview`
- Extended words: `prepaid`, `pretest`, `predict`, `preheat`,
  `pre-exist`, `pre-book`, `precooked`, `pre-sale`, `prevent`,
  `precaution`

Additional update on 2026-08-11:
...
Unit 33 `re-` vocabulary added on 2026-08-17 after the Daily Quick:

- Book words: `rearrange`, `recycle`, `renew`, `return`, `rewrite`
- Word families and support words: `arrange`, `cycle`, `recyclable`,
  `recycling`, `renewable`, `renewal`, `returnable`, `rewritable`
- Extended words: `reorganize`, `rebuild`, `recover`, `replace`, `replay`,
  `reconsider`, `remind`, `recreate`, `reuse`, `reunite`, `refund`,
...
Available results from the first August quiz week:

| Date | Type | Result | Notes |
|---|---|---:|---|
| 2026-08-03 | Daily Quick | 8/12 | Recovery heavy after July cumulative |
...
The earlier complete source files for Unit 01-21 were not available in this
workspace. This package includes all source files found locally from the
