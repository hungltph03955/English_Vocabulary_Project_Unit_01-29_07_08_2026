...
```mermaid
mindmap
  root((HỆ THỐNG TIỀN TỐ<br/>UNIT 22–42))
    THỜI GIAN · THỨ TỰ · LẶP LẠI
      mid- = giữa
        midday
        midterm
        midstream
      ...
      re- = lại · trở lại
        ...
        renew
        reconnect
    VỊ TRÍ · HƯỚNG · CHUYỂN ĐỘNG
      out- = ra ngoài · vượt hơn
        outside
        outsource
        outweigh
      over- = trên · quá mức
        ...
        overpay
        overlook
      sub- = dưới · phụ · thứ cấp
        submarine
        subtitle
        substandard
      trans- = qua · xuyên · chuyển
        transfer
        translate
        transparent
      under- = dưới · không đủ
        ...
        underpaid
        underestimate
      up- = lên · cao hơn · cải thiện
        update
        upgrade
        uplift
    SỐ LƯỢNG · MỨC ĐỘ · PHẠM VI
      multi- = nhiều
        multipurpose
        multinational
        multilingual
      semi- = nửa · một phần
        ...
        semiannual
        semi-permanent
      super- = trên · vượt mức · cực kỳ
        superhuman
        supervise
        superficial
      uni- = một · duy nhất · đồng nhất
        unicycle
        universe
        universal
    PHỦ ĐỊNH · SAI LỆCH · ĐỐI LẬP
      mis- = sai · nhầm · xử lý không đúng
        misuse
        mislead
        mishandle
      non- = không · không thuộc nhóm
        nonprofit
        non-essential
        non-urgent
      un- = không · ngược lại · tháo bỏ
        unfair
        unpredictable
        unlock
      ob- / op- = hướng tới · chống · cản
        object
        obstacle
        oppose
    QUAN HỆ · TIẾN LÊN · KẾT HỢP
      per- = xuyên qua · hoàn toàn
        perceive
        persevere
        persist
      pro- = tiến về trước · ủng hộ
        proceed
        promote
        provide
      syn- / sym- = cùng nhau · giống nhau
        synchronize
        synonym
        sympathy
```
